...
//    
    ...
    recoT->Branch("Vertex_mmelel_chi2", &mmelelVtxChi2_);
    recoT->Branch("Vertex_mmelel_ndof", &mmelelVtxNdof_);
    ...
    recoT->Branch("Vertex_elel_chi2", &elelVtxChi2_);
    recoT->Branch("Vertex_elel_ndof", &elelVtxNdof_);
    ...
    recoT->Branch("Vertex_mmlplp_chi2", &mmlplpVtxChi2_);
    recoT->Branch("Vertex_mmlplp_ndof", &mmlplpVtxNdof_);
    ...
    recoT->Branch("Vertex_lplp_chi2", &lplpVtxChi2_);
    recoT->Branch("Vertex_lplp_ndof", &lplpVtxNdof_);
...
//    }
    ...
    recoT->Branch("Vertex_mumu_chi2", &mumuVtxChi2_);
    recoT->Branch("Vertex_mumu_ndof", &mumuVtxNdof_);
...
void NtupleContainer::ClearTreeBranches() {
    ...
    mmelelVtxChi2_.clear();
    mmelelVtxNdof_.clear();
    mmelelVtxDr_.clear();
    mmelelVtxM_.clear();
    mmelelVtxPt_.clear();
    ...
    mmlplpVtxChi2_.clear();
    mmlplpVtxNdof_.clear();
    mmlplpVtxDr_.clear();
    mmlplpVtxM_.clear();
    mmlplpVtxPt_.clear();
