...
fitmin = .505 #.525 #.50 #.505
fitmax = .585 #.575 #.60 #.585
...
if req_elID == 2 or req_elID == 3:
    ...
    nparam = 7
    sigModel.set_params( mg=library.Param(.548, .543, .553), sg1=library.Param(.03, .001, .5), sg2=library.Param(.007, .001, .5), sg3=library.Param(.001, .00001, .5), sig1frac=library.Param(0.8, 0.1, 0.9), sig2frac=library.Param(0.2, 0.05, 0.95) )
